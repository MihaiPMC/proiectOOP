...
void Habitat::demonstrateSpecificBehavior(const std::shared_ptr<Animal> &animal) const {
    std::cout << "Demonstrating behavior for " << animal->getName() << " the " << animal->getSpecies() << std::endl;
    std::cout << "Age: " << animal->getAge() << " years, Weight: " << animal->getWeight() << " kg, Height: " << animal->
            getHeight() << " m" << std::endl;
    std::cout << "Health: " << (animal->getIsHealthy() * 100) << "%, Hunger: " << (animal->getHunger() * 100) << "%" <<
            std::endl;
...
void Habitat::renderAnimals(sf::RenderWindow &window, int tileSize,
...
void Habitat::highlightHabitat(sf::RenderWindow &window, int tileSize, const sf::Color &color,
