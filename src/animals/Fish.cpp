...
Fish::Fish(const std::string &name, const std::string &species, int age, float weight, float height,
           const std::string &finType, float isHealthy, int price, float hunger)
