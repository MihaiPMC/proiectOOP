...
public:
    Bird(const std::string &name, const std::string &species, int age, float weight, float height, float wingSpan,
         float isHealthy = 1.0f, int price = 1000, float hunger = 0.0f);
