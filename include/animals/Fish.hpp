...
public:
    Fish(const std::string &name, const std::string &species, int age, float weight, float height,
         const std::string &finType, float isHealthy = 1.0f, int price = 1000, float hunger = 0.0f);
